"""
Django management command to update Resources page to link to local Templates article
"""
...
class Command(BaseCommand):
    help = 'Update Resources page to link to local Templates article instead of external URL'

    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('\n=== Updating Resources Page Article Link ===\n'))
        ...
        try:
            ...
            for block in body_data:
                if block['type'] == 'html':
                    ...
                    old_link = 'https://qualitation.co.uk/dont-use-templates-to-achieve-an-iso-standard'
                    new_link = '/dont-use-templates-to-achieve-an-iso-standard/'
                    ...
                    if old_link in html_content:
                        ...
                        self.stdout.write(self.style.SUCCESS('✓ Updated Templates article link to local page'))
                        break
            ...
            self.stdout.write(self.style.SUCCESS('✓ Article 1 now links to: /dont-use-templates-to-achieve-an-iso-standard/'))
